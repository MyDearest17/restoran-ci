		...
		<div class="row">
			...
			<div class="col-4">
                <div class="card border-info">
                    <h5 class="car-header mt-3 ml-3">Form Ubah Meja</h5>
                    <div class="card-body">
                        <form action ="" method ="post">
                            <div class ="form-group">
                            <label for ="no_meja">NO Meja</label>
                            <input type ="text" name="no_meja" id ="no_meja" class ="form-control" value ="<?=$meja['no_meja'] ?>">
                            <small class ="form-text text-danger"><?= form_error('no_meja')?></small>
                            </div>
                            <div class ="form-group">
                            <label for ="jumlah_orang">Jumlah Orang</label>
                            <input type ="number" name="jumlah_orang" id ="jumlah_orang" class ="form-control" value ="<?=$meja['jumlah_orang'] ?>">
                            ...
                            <button type ="submit" name ="tambah" class ="btn btn-info float-right">Ubah</button>
                        </form>
                    </div>
                </div>
            </div>
