		...
		<div class="row">
			...
			<div class="col-4">
                <div class="card border-info">
                    <h5 class="car-header mt-3 ml-3">Form Tambah Menu</h5>
                    <div class="card-body">
                        <form action ="" method ="post">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="jenis_masakan" class="form-check-input" value="makanan">
                                <label class="form-check-label">Makanan</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" name="jenis_masakan" class="form-check-input" value="minuman">
                                <label class="form-check-label">Minuman</label>
                            </div>
                            <small class ="form-text text-danger"><?= form_error('harga')?></small>
                            <div class="form-group">
                                <label>Foto</label><br>
                                <input type="file" name="foto_masakan" class="">
	                        </div>
